...
class ReplicateController
{
    ...
    /**
     * Système :
     * Instantie l'objet ReplicateController
     * @return ReplicateController object *
     */
    public static function getInstance(): ReplicateController
    {
        if (ReplicateController::$instance === null) {
            ReplicateController::$instance = new ReplicateController;
        }
        return ReplicateController::$instance;
    }
    ...
    /**
     * Affichage :
     * Affiche la bannière de register
     * @return void
     */
