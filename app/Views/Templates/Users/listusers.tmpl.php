            ...
            <table class="table table-striped table-condensed">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="/users/deleteuser/<?= $uid; ?>" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-800 hover:bg-lime-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-800">
