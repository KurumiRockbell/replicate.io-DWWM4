...
<div class="container mt-3">
    <div class="row mb-3 animated fadeIn">
        <?php require_once ReplicateController::partial('/MvcUI/categoryfilter.part.php'); ?>
    </div>
    <div class="row mb-3 animated fadeIn">
        <?php require_once ReplicateController::partial('/MvcUI/orderfilter.part.php'); ?>
    </div>
    <div class="row grid">
        <?php foreach ($data['products'] as $product) {
            extract($product); ?>
            <div class="card grid-item product <?= ReplicateController::sanitizeName($CategoryName); ?>">
                ...
                <div class="card-body">
                    ...
                    <div class="card-text">
                        <table class="table table-sm">
                            ...
                            <tr>
                                <td>
                                    <mark class="float-end"><?= ReplicateController::formalizeEuro($UnitPrice); ?>.</mark>
                                </td>
                            </tr>
                            <tr>
                                <td>
