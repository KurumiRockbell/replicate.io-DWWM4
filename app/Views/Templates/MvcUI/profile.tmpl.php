...
<div class="relative">
    ...
    <div class="z-20 -mt-72 p-8 flex flex-col items-center inset-0">
        <div class="mt-12 w-full max-w-sm bg-black border border-lime-400 rounded-lg shadow">
            <div class="flex justify-end px-4 pt-4">
                <button id="dropdownButton" data-dropdown-toggle="dropdown" class="inline-block text-teal-50 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg text-sm p-1.5" type="button">
            ...
            <div class="flex flex-col items-center pb-8 bg-black">
                ...
                <div class="flex mt-4 mb-6 mx-6 space-x-3 md:mt-6">
                    <a href="#" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-indigo-800 rounded-lg hover:bg-lime-400 focus:ring-4 focus:outline-none focus:ring-indigo-800 ">Follow
                        Me</a>
                    <a href="#" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 ">My
                        collection</a>
                </div>
            </div>
        </div>
    ...
    <div class="text-justify flex-col flex items-center w-full">
        <h1 class="text-indigo-800 font-black text-5xl text-center md:text-6xl lg:text-7xl">
            MY CARDS
        </h1>
        <div class="flex flex-col  col-2 lg:flex-row">
            ...
            <div class="w-3/4 max-w-sm bg-black border border-indigo-800 rounded-lg shadow mt-12 mb-12 mx-auto">
                <img class="p-8 rounded-t-lg" src="<?= ReplicateController::assets('/imgs/cardsA.png'); ?>" alt="product image" />
